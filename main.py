...
# أي رسالة خطأ واضحة من السيرفر
return "error", result_raw

except Exception:
# أي خطأ عام يتحسب error
return "error", "Error"
...
card_full = " ".join(context.args) # 4242424242424242|MM|YY|CVV
if not card_full:
...
line = line.strip()
# ناخد البطاقة كاملة: 4242424242424242|MM|YY|CVV
