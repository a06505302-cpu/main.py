...
r = await client.get("https://mainpy-production-3201.up.railway.app/check", params=params)
...
if name=="main":
main() تقدر تظبك دي http://151.247.197.54:5500/paypalمعا البوت بدل القديمه
